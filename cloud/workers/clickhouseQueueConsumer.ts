 ...
 *         └── ClickHouseClientWorkersLive (fetch + HTTP API)
 * ```
 *
 * ## Message Format
 *
...
import { ClickHouseClientWorkersLive } from "@/clickhouse/client";
import {
 ...
 */
export interface QueueConsumerEnv extends CloudflareEnvironment {
